...
<>
<div>
<div className='grid grid-cols-3  text-white home'> 
  ...
  <button className="text-3xl text-white bg-green h-14 w-64 rounded-3xl">GET Startes</button>
  </div>
  </div>
  <div className="pt-5 mt-8">
  <img src="watt.webp" alt="pauline's meter" className='ml-20'/>
  </div>
 </div>
